...
namespace TCPNetwork.Packets
{
    public class ModConfigData
    {
        ...
        {
            return $"ModConfigData|{_stepMode}|Mods:{_configFile?.ModConfigs?.Count}|ReqProfile:{_requestOptionsProfile}|UploadProfile:{_uploadOptionsProfile}|Chunk:{_isOptionsProfileChunk} {(_chunkIndex + 1)}/{_chunkCount}";
        }
    }
}